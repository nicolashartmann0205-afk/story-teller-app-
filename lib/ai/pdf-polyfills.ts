/**
 * Polyfills for browser APIs needed by pdfjs-dist in Node.js/serverless environments
 * This module MUST be imported before any code that uses pdf-parse or pdfjs-dist
 */

// Setup polyfills immediately when this module is imported
...
if (typeof globalObj.Path2D === 'undefined') {
  globalObj.Path2D = class Path2D {
    // Minimal Path2D polyfill - pdfjs-dist may not use all methods
