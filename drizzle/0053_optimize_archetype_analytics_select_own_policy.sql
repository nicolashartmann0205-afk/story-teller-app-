-- Optimize archetype_analytics_select_own per advisor recommendation.
...
BEGIN
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'archetype_analytics_select_own'
  ) THEN
    ALTER POLICY "archetype_analytics_select_own"
