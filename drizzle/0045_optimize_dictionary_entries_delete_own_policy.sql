-- Optimize dictionary_entries_delete_own per advisor recommendation.
...
BEGIN
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'dictionary_entries_delete_own'
  ) THEN
    ALTER POLICY "dictionary_entries_delete_own"
