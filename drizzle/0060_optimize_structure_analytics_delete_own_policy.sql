-- Optimize structure_analytics_delete_own per advisor recommendation.
...
BEGIN
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'structure_analytics_delete_own'
  ) THEN
    ALTER POLICY "structure_analytics_delete_own"
